...
mount -t overlay overlay -o lowerdir=/Shards/System/usr,upperdir=/Shards/Desktop/usr,workdir=/Shards/Desktop/tmp/usr /usr

echo "Creating Overlay with System and Desktop for /mnt/var"
mount -t overlay overlay -o lowerdir=/Shards/System/var,upperdir=/Shards/Desktop/var,workdir=/Shards/Desktop/tmp/var /var

echo "Creating Overlay with System and Desktop for /mnt/opt"
mount -t overlay overlay -o lowerdir=/Shards/System/opt,upperdir=/Shards/Desktop/opt,workdir=/Shards/Desktop/tmp/opt /opt
